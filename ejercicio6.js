...
const totalScore = exams.reduce((accumulator, current) => accumulator + current.score, 0);
console.log('Suma total de notas:', totalScore);

// 6.2 Suma de las notas de los alumnos aprobados (score >= 5)
const totalPassedScore = exams
  .filter(exam => exam.score >= 5)
  .reduce((accumulator, current) => accumulator + current.score, 0);
console.log('Suma de notas aprobados:', totalPassedScore);
